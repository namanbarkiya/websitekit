  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          // PERF: animating width forces repeated reflow of the main content.
          // Keep the width change instantaneous to avoid jank on heavy pages.
      ...
      <div
        ...
        className={cn(
          // PERF: avoid animating width (layout) where possible; keep offcanvas slide.
...
function SidebarMenuSkeleton({
  ...
  const width = React.useMemo(() => {
    // Compute the width once during initial mount to keep it stable across renders.
    const initial =
